        ...
        <div class="form-row">
         ...
         <div class="form-row">
            <div class="col">
                ...
                <asp:TextBox ID="ClienteTextBox" CssClass="form-control" placeholder="Nombre" runat="server" />
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" MaxLength="200"
                    ControlToValidate="ClienteTextBox"
                    ErrorMessage="Campo Descripcion obligatorio" ForeColor="black"
                    Display="Dynamic" SetFocusOnError="True"
                    ToolTip="Campo Cliente obligatorio" ValidationGroup="Agregar">Por favor llenar el campo Cliente
